...
func (*TensorProto) Descriptor() ([]byte, []int) { return fileDescriptor19, []int{0} }
...
func (*VariantTensorDataProto) Descriptor() ([]byte, []int) { return fileDescriptor19, []int{1} }
...
func init() { proto.RegisterFile("tensorflow/core/framework/tensor.proto", fileDescriptor19) }
