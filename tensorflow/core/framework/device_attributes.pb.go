...
func (*InterconnectLink) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{0} }
...
func (*LocalLinks) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{1} }
...
type DeviceLocality struct {
	...
	NumaNode int32 `protobuf:"varint,2,opt,name=numa_node,json=numaNode" json:"numa_node,omitempty"`
...
func (*DeviceLocality) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{2} }
...
func (*DeviceAttributes) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{3} }
