...
func (*PredictRequest) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{0} }
...
func (*PredictResponse) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{1} }
...
func init() { proto.RegisterFile("tensorflow_serving/apis/predict.proto", fileDescriptor9) }
