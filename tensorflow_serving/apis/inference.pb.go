...
func (*InferenceTask) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{0} }
...
func (*InferenceResult) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{1} }
...
func (*MultiInferenceRequest) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{2} }
...
func (*MultiInferenceResponse) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{3} }
...
func init() { proto.RegisterFile("tensorflow_serving/apis/inference.proto", fileDescriptor3) }
