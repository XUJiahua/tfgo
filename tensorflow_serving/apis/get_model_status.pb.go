...
import fmt "fmt"
import math "math"
import tensorflow_serving1 "tensorflow_serving/util"
...
func (ModelVersionStatus_State) EnumDescriptor() ([]byte, []int) { return fileDescriptor2, []int{1, 0} }
...
func (*GetModelStatusRequest) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{0} }
...
type ModelVersionStatus struct {
	...
	// Model state.
	State ModelVersionStatus_State `protobuf:"varint,2,opt,name=state,enum=tensorflow.serving.ModelVersionStatus_State" json:"state,omitempty"`
	// Model status.
	Status *tensorflow_serving1.StatusProto `protobuf:"bytes,3,opt,name=status" json:"status,omitempty"`
}
...
func (*ModelVersionStatus) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{1} }
...
func (m *ModelVersionStatus) GetStatus() *tensorflow_serving1.StatusProto {
	if m != nil {
		return m.Status
	}
	return nil
...
func (*GetModelStatusResponse) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{2} }
...
func init() { proto.RegisterFile("tensorflow_serving/apis/get_model_status.proto", fileDescriptor2) }
