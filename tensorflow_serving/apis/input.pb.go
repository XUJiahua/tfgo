...
func (*ExampleList) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{0} }
...
func (*ExampleListWithContext) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{1} }
...
func (*Input) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{2} }
...
func init() { proto.RegisterFile("tensorflow_serving/apis/input.proto", fileDescriptor4) }
