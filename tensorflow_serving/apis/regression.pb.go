...
func (*Regression) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{0} }
...
func (*RegressionResult) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{1} }
...
func (*RegressionRequest) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{2} }
...
func (*RegressionResponse) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{3} }
...
func init() { proto.RegisterFile("tensorflow_serving/apis/regression.proto", fileDescriptor10) }
