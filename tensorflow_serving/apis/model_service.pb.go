...
func (c *modelServiceClient) GetModelStatus(ctx context.Context, in *GetModelStatusRequest, opts ...grpc.CallOption) (*GetModelStatusResponse, error) {
	...
	err := grpc.Invoke(ctx, "/tensorflow.serving.ModelService/GetModelStatus", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *modelServiceClient) HandleReloadConfigRequest(ctx context.Context, in *ReloadConfigRequest, opts ...grpc.CallOption) (*ReloadConfigResponse, error) {
	...
	err := grpc.Invoke(ctx, "/tensorflow.serving.ModelService/HandleReloadConfigRequest", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func init() { proto.RegisterFile("tensorflow_serving/apis/model_service.proto", fileDescriptor7) }
